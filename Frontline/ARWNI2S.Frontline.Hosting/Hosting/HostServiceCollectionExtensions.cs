...
namespace ARWNI2S.Frontline.Hosting
{
    /// <summary>
    ...
    public static class HostServiceCollectionExtensions
    {
        ...
        {
            services.AddSingleton<IExecutionContextAccessor, FrontlineContextAccessor>();
        }
        ...
        //    {
        //        var blobServiceClient = new BlobServiceClient(nodeSettings.Get<AzureBlobConfig>().ConnectionString);
        //        var blobContainerClient = blobServiceClient.GetBlobContainerClient(nodeSettings.Get<AzureBlobConfig>().DataProtectionKeysContainerName);
        ...
        //        if (!nodeSettings.Get<AzureBlobConfig>().DataProtectionKeysEncryptWithVault)
        //            return;

        //        var keyIdentifier = nodeSettings.Get<AzureBlobConfig>().DataProtectionKeysVaultId;
