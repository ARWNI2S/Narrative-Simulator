...
{
    internal abstract class Actor : IActorEntity
    {
        #region Fields

        //private EntityHierarchyBuilder? _builder;

        //private TreeNode<IActorComponent>? _componentTreeRoot;
        ...
        public SimulationScene Scene { get; } = default!;

        public bool IsValidChecked(ISimulableEntity simulableEntity)
        {
            throw new NotImplementedException();
        }

        //public IActorComponent RootComponent
        //{
        //	get
        //	{
        //		if (_componentTreeRoot == null)
        //		{
        //			if (_builder == null)
        //				throw new InvalidOperationException($"Invalid or malformed actor");

        //			return _builder.GetRootObject();
        //		}

        //		return _componentTreeRoot.Value;
        //	}
        //}
        ...
        //protected ActorEntityBase(EntityHierarchyBuilder? rootBuilder = null) : base()
        //{
        //	_builder = rootBuilder ?? new EntityHierarchyBuilder(this, new DefaultRootComponent(this));
        //}
        ...
        Guid ISimulableEntity.Id { get => Id; set => Id = value; }
