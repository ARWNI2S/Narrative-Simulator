...
{
    public class NodeSession : INodeSession, ILogger, ILoggerAccessor
    {
        ...
        void INodeSession.Initialize(IServerInfo server, IConnection connection)
        {
        ...
        IConnection INodeSession.Connection
        {
            get { return _connection; }
        }
        ...
        ValueTask INodeSession.SendAsync(ReadOnlyMemory<byte> data, CancellationToken cancellationToken)
        {
            return _connection.SendAsync(data, cancellationToken);
        }

        ValueTask INodeSession.SendAsync<TPackage>(IPackageEncoder<TPackage> packageEncoder, TPackage package, CancellationToken cancellationToken)
        {
            return _connection.SendAsync(packageEncoder, package, cancellationToken);
        }

        void INodeSession.Reset()
        {
