...
With the code in this repository, you can build the full Narrative Interactive Intelligent Simulator (NI2S) for Windows, Mac, and Linux; compile NI2S based game services for a variety of target engines, including Unreal Engine, Unity, and Cry Engine; and build tools like NI2S Knowledge and NI2S Fronline. Modify the code in any way you can imagine, and share your changes with others!

We have a vast amount of [official documentation](http://not.available.yet) available for the engine. If you're looking for the answer to something, you may want to start in one of these places:

*   [Programming and Scripting in Unreal Engine](https://not.available.yet/unreal-engine-programming-and-scripting)
...
*   The **[master branch](https://github.com/ARWNI2S/Narrative-Simulator/tree/master)** is the hub of changes to UE4 from all our engine development teams. It�s not subject to as much testing as release branches, so if you�re using UE4 this may not be the best choice for you.
...
1.  Both cross-compiling and native builds are supported.
    ...
    -   **Cross-compiling** is handy for Windows developers who want to package a game for Linux with minimal hassle. It requires a cross-compiler toolchain to be installed. See the [Linux cross-compiling page in the documentation](https://not.available.yet/linux-development-requirements-for-unreal-engine/).
...
*   **Android** support will be downloaded by the setup script if you have the Android NDK installed. See the [Android Quick Start guide](https://not.available.yet/setting-up-unreal-engine-projects-for-android-development/).

*   **iOS** development requires a Mac. Instructions are in the [iOS Quick Start guide](https://not.available.yet/setting-up-an-unreal-engine-project-for-ios/).
...
*   Development for consoles and other platforms with restricted access, like **Sony PlayStation**, **Microsoft Xbox**, and **Nintendo Switch**, is only possible if you have a registered developer account with those third-party vendors.
    ...
    Depending on the platform, additional documentation or guidance may be available in the [Unreal Developer Network support site](https://udn.unrealengine.com/s/), or as a downloadable archive in the section of the [Unreal Engine Forums](https://not.available.yet/c/development-discussion/platforms/130) that is dedicated to your platform.
...
We welcome contributions to Unreal Engine development through [pull requests](https://github.com/ARWNI2S/Narrative-Simulator/pulls/) on GitHub.

We prefer to take pull requests in our active development branches, particularly for new features. For UE5, use the **ue5-main** branch; for UE4, use the **master** branch. Please make sure that all new code adheres to the [Epic coding standards](https://not.available.yet/epic-cplusplus-coding-standard-for-unreal-engine/).

For more information on the process and expectations, see [the documentation](https://not.available.yet/contributing-to-the-unreal-engine/).
...
The first time you start the editor from a fresh source build, you may experience long load times. The engine is optimizing content for your platform and storing it in the _[derived data cache](https://not.available.yet/derived-data-cache/)_. This should only happen once.
