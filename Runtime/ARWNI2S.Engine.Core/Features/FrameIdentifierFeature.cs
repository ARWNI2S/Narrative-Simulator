...
{
    internal class FrameIdentifierFeature : IFrameIdentifierFeature
    {
        ...
        public string TraceIdentifier
        {
            get
            {
                ...
                if (_id == null)
                {
                    _id = GenerateFrameId(Interlocked.Increment(ref _requestId));
                }
                return _id;
            }
            set
        ...
        private static string GenerateFrameId(long id)
        {
