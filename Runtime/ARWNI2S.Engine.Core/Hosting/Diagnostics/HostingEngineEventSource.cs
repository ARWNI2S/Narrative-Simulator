...
{
    internal sealed class HostingEngineEventSource : EventSource
    {
        public static readonly HostingEngineEventSource Log = new();
        ...
        internal HostingEngineEventSource()
            : base("ARWNI2S.Engine.Core", EventSourceSettings.EtwManifestEventFormat)
        {
        }

        // Used for testing
        internal HostingEngineEventSource(string eventSourceName)
