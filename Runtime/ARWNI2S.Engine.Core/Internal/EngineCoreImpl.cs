...
{
    internal class EngineCoreImpl : IEngine
    {
        ...
        public async Task StartAsync<TContext>(IEngine<TContext> engine, CancellationToken cancellationToken) where TContext : notnull
        {
            try
            {
                ValidateOptions();
