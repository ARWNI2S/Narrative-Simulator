...
{
    public class NamedPipesConnectionListener : IConnectionListener
    {
        ...
        //private INamedPipesSessionIdentifierProvider _namedPipesSessionIdentifierProvider;

        public NamedPipesConnectionListener(ListenOptions options, IConnectionFactory connectionFactory, /*INamedPipesSessionIdentifierProvider namedPipesSessionIdentifierProvider,*/ ILogger logger)
        {
            Options = options;
            ConnectionFactory = connectionFactory;
            _logger = logger;
            //_namedPipesSessionIdentifierProvider = namedPipesSessionIdentifierProvider;
        }
        ...
        private async Task KeepAccept(Socket listenSocket)
        {
            while (!_cancellationTokenSource.IsCancellationRequested)
            {
                try
                {
                    ...
                    //var sessionID = _namedPipesSessionIdentifierProvider.GetSessionIdentifier(remoteEndPoint, packageData);
