namespace ARWNI2S.Portal.Framework.Http
{
    /// <summary>
    ...
    public static partial class HttpDefaults
    {
        ...
        /// </summary>
        public static string IsPostBeingDoneRequestItem => "draco.IsPOSTBeingDone";
        ...
        /// </summary>
        public static string GenericRouteInternalRedirect => "draco.RedirectFromGenericPathRoute";
    }
}