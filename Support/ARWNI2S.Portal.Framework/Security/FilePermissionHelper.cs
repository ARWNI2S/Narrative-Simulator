...
namespace ARWNI2S.Portal.Framework.Security
{
    ...
    public static class FilePermissionHelper
    {
        ...
        [SupportedOSPlatform("windows")]
        private static bool CheckPermissionsInWindows(IEngineFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
        {
        ...
        /// <param name="checkDelete">Check delete</param>
        /// <returns>Result</returns>
        public static bool CheckPermissions(this IEngineFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
        {
        ...
        /// </summary>
        /// <returns>Result</returns>
        public static IEnumerable<string> GetDirectoriesWrite(this IEngineFileProvider fileProvider)
        {
            ...
            var dirsToCheck = new List<string>
            {
                ...
                fileProvider.Combine(rootDir, @"Modules\Uploaded"),
        ...
        /// </summary>
        /// <returns>Result</returns>
        public static IEnumerable<string> GetFilesWrite(this IEngineFileProvider fileProvider)
        {
            return new List<string>
            {
                fileProvider.MapPath(PluginDefaults.PluginsInfoFilePath),
