...
namespace ARWNI2S.Portal.Services.Blogs
{
    ...
    public partial interface IBlogService
    {
        ...
        /// </returns>
        Task<IPagedList<BlogPost>> GetAllBlogPostsAsync(int nodeId = 0, int languageId = 0,
        ...
        /// The task result contains the blog posts
        /// </returns>
        Task<IPagedList<BlogPost>> GetAllBlogPostsByTagAsync(int nodeId = 0,
        ...
        /// </returns>
        Task<IList<BlogPostTag>> GetAllBlogPostTagsAsync(int nodeId, int languageId, bool showHidden = false);
        ...
        /// </returns>
        Task<IList<BlogComment>> GetAllCommentsAsync(int userId = 0, int nodeId = 0, int? blogPostId = null,
        ...
        /// </returns>
        Task<int> GetBlogCommentsCountAsync(BlogPost blogPost, int nodeId = 0, bool? isApproved = null);
