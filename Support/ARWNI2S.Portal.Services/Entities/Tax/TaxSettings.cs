...
namespace ARWNI2S.Portal.Services.Entities.Tax
{
    ...
    public partial class TaxSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this node will exempt eligible VAT-registered users from VAT
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should notify an administrator when a new VAT number is submitted
        /// </summary>
