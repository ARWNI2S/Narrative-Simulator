...
namespace ARWNI2S.Portal.Services.Html.CodeFormatter
{
    /// <summary>
    ...
    public partial class CodeFormatHelper
    {
        ...
        private static readonly Regex _regexHtml = CodeFormatHelperRegexHtml();

        private static readonly Regex _regexCode = CodeFormatHelperRegexCode();
        ...
        private static partial Regex CodeFormatHelperRegexHtml();
        [GeneratedRegex("\\[code\\](?<inner>(.*?))\\[/code\\]", RegexOptions.IgnoreCase | RegexOptions.Compiled, "es-ES")]
        private static partial Regex CodeFormatHelperRegexCode();
