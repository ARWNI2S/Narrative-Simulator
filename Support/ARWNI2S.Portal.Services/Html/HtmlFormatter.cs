...
namespace ARWNI2S.Portal.Services.Html
{
    ...
    public partial class HtmlFormatter : IHtmlFormatter
    {
        ...
        protected static string EnsureOnlyAllowedHtml(string text)
        {
            ...
            var m = HtmlFormatterRegexEnsureOnlyAllowedHtml().Matches(text);
        ...
        public virtual string StripTags(string text)
        {
            ...
            text = HtmlFormatterRegexStripTags1().Replace(text, "><");
            text = HtmlFormatterRegexStripTags2().Replace(text, "$2");
            text = HtmlFormatterRegexStripTags3().Replace(text, "@");
        ...
        public virtual string ReplaceAnchorTags(string text)
        {
            ...
            text = HtmlFormatterRegexReplaceAnchorTags().Replace(text, "$1");
            return text;
        }
        ...
        private static partial Regex HtmlFormatterRegexEnsureOnlyAllowedHtml();
        [GeneratedRegex("(>)(\\r|\\n)*(<)")]
        private static partial Regex HtmlFormatterRegexStripTags1();
        [GeneratedRegex("(<[^>]*>)([^<]*)")]
        private static partial Regex HtmlFormatterRegexStripTags2();
        ...
        private static partial Regex HtmlFormatterRegexStripTags3();
        [GeneratedRegex("<a\\b[^>]+>([^<]*(?:(?!</a)<[^<]*)*)</a>", RegexOptions.IgnoreCase)]
        private static partial Regex HtmlFormatterRegexReplaceAnchorTags();
