...
namespace ARWNI2S.Portal.Services.Html
{
    ...
    public partial class ResolveLinksHelper
    {
        ...
        public static string FormatText(string text)
        {
            ...
            foreach (Match match in _regex.Matches(text).Cast<Match>())
            {
        ...
        [GeneratedRegex("((http://|https://|www\\.)([A-Z0-9.\\-]{1,})\\.[0-9A-Z?;~&\\(\\)#,=\\-_\\./\\+]{2,})", RegexOptions.IgnoreCase | RegexOptions.Compiled, "es-ES")]
