namespace ARWNI2S.Portal.Services.Installation
{
    ...
    public static partial class ISO3166
    {
        ...
        /// </summary>
        /// <param name="countryCode"></param>
        /// <returns><see cref="IEnumerable{LocalizationInfo}"/></returns>
...
#pragma warning disable CA1861 // Evitar matrices constantes como argumentos
            return new[] {
                new ISO3166Country("Afghanistan", "AF", "AFG", 4, dialCodes),
                ...
                new ISO3166Country("Spain", "ES", "ESP", 724, new[] { "34" }, true, localizationInfo: new[] { new LocalizationInfo("ca-ES", "Catalan"), new LocalizationInfo("es-ES", "Spanish") }),
