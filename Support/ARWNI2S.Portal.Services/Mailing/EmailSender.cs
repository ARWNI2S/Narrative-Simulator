...
namespace ARWNI2S.Portal.Services.Mailing
{
    ...
    public partial class EmailSender : IEmailSender
    {
        ...
        public EmailSender(IDownloadService downloadService, IEngineFileProvider fileProvider, ISmtpBuilder smtpBuilder)
        {
        ...
        protected static MimePart CreateMimeAttachment(Download download)
        {
        ...
        /// <returns>A leaf-node MIME part that contains an attachment.</returns>
        protected static MimePart CreateMimeAttachment(string attachmentFileName, byte[] binaryContent, DateTime cDate, DateTime mDate, DateTime rDate)
        {
            if (!ContentType.TryParse(MimeT.GetMimeType(attachmentFileName), out var mimeContentType))
