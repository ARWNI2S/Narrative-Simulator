...
namespace ARWNI2S.Portal.Services.Mailing
{
    ...
    public static class EventPublisherExtensions
    {
        ...
        public static async Task PublishNewsletterSubscribeAsync(this INodeEventPublisher eventPublisher, NewsLetterSubscription subscription)
        {
        ...
        /// <param name="subscription">The newsletter subscription.</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public static async Task PublishNewsletterUnsubscribeAsync(this INodeEventPublisher eventPublisher, NewsLetterSubscription subscription)
        {
        ...
        /// <param name="tokens">Tokens</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public static async Task MessageTokensAddedAsync<U>(this INodeEventPublisher eventPublisher, MessageTemplate message, IList<U> tokens)
        {
