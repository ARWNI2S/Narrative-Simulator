...
namespace ARWNI2S.Portal.Services.Mailing
{
    ...
    public partial interface IMessageTemplateService
    {
        ...
        /// </returns>
        Task<IList<MessageTemplate>> GetMessageTemplatesByNameAsync(string messageTemplateName, int? nodeId = null);
        ...
        /// </returns>
        Task<IList<MessageTemplate>> GetAllMessageTemplatesAsync(int nodeId, string keywords = null, bool? isActive = null);
