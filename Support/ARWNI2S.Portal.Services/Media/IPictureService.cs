...
namespace ARWNI2S.Portal.Services.Media
{
    ...
    public partial interface IPictureService
    {
        ...
        ///// </returns>
        //Task<IList<Picture>> GetPicturesByTournamentIdAsync(int tournamentId, int recordsToReturn = 0);
        ...
        ///// The task result contains the pictures
        ///// </returns>
        //Task<IList<Picture>> GetPicturesByQuestIdAsync(int questId, int recordsToReturn = 0);
        ...
        ///// The task result contains the pictures
        ///// </returns>
        //Task<IList<Picture>> GetPicturesByGameTitleIdAsync(int titleId, int recordsToReturn = 0);
