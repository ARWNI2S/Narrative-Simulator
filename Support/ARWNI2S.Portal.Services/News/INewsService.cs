...
namespace ARWNI2S.Portal.Services.News
{
    ...
    public partial interface INewsService
    {
        ...
        /// </returns>
        Task<IPagedList<NewsItem>> GetAllNewsAsync(int languageId = 0, int nodeId = 0,
        ...
        /// </returns>
        Task<IList<NewsComment>> GetAllCommentsAsync(int userId = 0, int nodeId = 0, int? newsItemId = null,
        ...
        /// </returns>
        Task<int> GetNewsCommentsCountAsync(NewsItem newsItem, int nodeId = 0, bool? isApproved = null);
