...
namespace ARWNI2S.Portal.Services.News
{
    ...
    public partial class NewsService : INewsService
    {
        ...
        /// <param name="nodeId">Node identifier; 0 if you want to get all records</param>
        ...
        /// </returns>
        public virtual async Task<IPagedList<NewsItem>> GetAllNewsAsync(int languageId = 0, int nodeId = 0,
        ...
        /// </returns>
        public virtual async Task<IList<NewsComment>> GetAllCommentsAsync(int userId = 0, int nodeId = 0, int? newsItemId = null,
        ...
        /// </returns>
        public virtual async Task<int> GetNewsCommentsCountAsync(NewsItem newsItem, int nodeId = 0, bool? isApproved = null)
        {
            ...
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(NewsServicesDefaults.NewsCommentsNumberCacheKey, newsItem, nodeId, isApproved);
