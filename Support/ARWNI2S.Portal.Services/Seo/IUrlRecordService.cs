...
namespace ARWNI2S.Portal.Services.Seo
{
    ...
    public partial interface IUrlRecordService
    {
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SaveSlugAsync<T>(T entity, string slug, int languageId) where T : DataEntity, ISlugSupported;
        ...
        /// </returns>
        Task<string> ValidateSeNameAsync<T>(T entity, string seName, string name, bool ensureNotEmpty) where T : DataEntity, ISlugSupported;
