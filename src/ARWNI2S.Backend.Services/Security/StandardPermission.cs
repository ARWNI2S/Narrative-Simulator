namespace ARWNI2S.Backend.Services.Security
{
    ...
    public partial class StandardPermission
    {
        ...
        {
            public const string GDPR_MANAGE = $"{nameof(Users)}.GDPRManage";
            public const string CUSTOMERS_VIEW = $"{nameof(Users)}.UsersView";
            public const string CUSTOMERS_CREATE_EDIT_DELETE = $"{nameof(Users)}.UsersCreateEditDelete";
            public const string CUSTOMERS_IMPORT_EXPORT = $"{nameof(Users)}.UsersImportExport";
            public const string CUSTOMERS_IMPERSONATION = $"{nameof(Users)}.UsersImpersonation";
            public const string CUSTOMER_ROLES_VIEW = $"{nameof(Users)}.UserRolesView";
            public const string CUSTOMER_ROLES_CREATE_EDIT_DELETE = $"{nameof(Users)}.UserRolesCreateEditDelete";
            public const string VENDORS_VIEW = $"{nameof(Users)}.VendorsView";
            public const string VENDORS_CREATE_EDIT_DELETE = $"{nameof(Users)}.VendorsCreateEditDelete";
            public const string ACTIVITY_LOG_VIEW = $"{nameof(Users)}.ActivityLogView";
            public const string ACTIVITY_LOG_DELETE = $"{nameof(Users)}.ActivityLogDelete";
            public const string ACTIVITY_LOG_MANAGE_TYPES = $"{nameof(Users)}.ActivityLogManageTypes";
        }
        ...
        public partial class Reports
        {
            ...
            public const string REGISTERED_CUSTOMERS = $"{nameof(Reports)}.RegisteredUsers";
            public const string CUSTOMERS_BY_ORDER_TOTAL = $"{nameof(Reports)}.UsersByOrderTotal";
            public const string CUSTOMERS_BY_NUMBER_OF_ORDERS = $"{nameof(Reports)}.UsersByNumberOfOrders";
        }
