...
namespace ARWNI2S.Backend.Services.Users.Entities
{
    ...
    public partial class UserSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether users are required to re-login after password changing
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether deleted user records should be suffixed with "-DELETED"
        /// </summary>
