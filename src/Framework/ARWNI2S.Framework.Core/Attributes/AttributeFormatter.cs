...
using ARWNI2S.Framework.Attributes.Entities;
...
namespace ARWNI2S.Framework.Attributes
{
        ...
        where TAttributeValue : BaseAttributeValue
    {
        ...
        protected readonly ITextFormatter _textFormatter;
        ...
        public AttributeFormatter(IAttributeParser<TAttribute, TAttributeValue> attributeParser,
            ...
            ITextFormatter htmlFormatter,
            ILocalizationService localizationService,
            IWorkingContext workingContext)
        {
            _attributeParser = attributeParser;
            _attributeService = attributeService;
            _textFormatter = htmlFormatter;
                ...
                for (var j = 0; j < valuesStr.Count; j++)
                {
                    ...
                    if (!attribute.ShouldHaveValues)
                    {
                        ...
                        if (attribute.AttributeControlType == AttributeControlType.MultilineTextbox)
                        {
                            ...
                            formattedAttribute =
                                $"{attributeName}: {_textFormatter.FormatText(valueStr, false, true, false, false, false, false)}";
