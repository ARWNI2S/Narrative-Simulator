...
namespace ARWNI2S.Framework.Common
{
    ...
    public partial interface IGenericAttributeService
    {
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SaveAttributeAsync<TPropType>(DataEntity entity, string key, TPropType value, int storeId = 0);
        ...
        /// </returns>
        Task<TPropType> GetAttributeAsync<TPropType>(DataEntity entity, string key, int storeId = 0, TPropType defaultValue = default);
