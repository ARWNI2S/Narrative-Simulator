...
namespace ARWNI2S.Framework.Common
{
    ...
    public partial class NopHttpClient
    {
        ...
        protected readonly IWorkingContext _workContext;
        ...
        public virtual async Task<string> GetLicenseCheckDetailsAsync()
        {
            ...
            var url = string.Format(CommonDefaults.NopLicenseCheckPath,
                storeUrl,
        ...
        public virtual async Task<RssFeed> GetNewsRssAsync()
        {
            ...
            var language = _languageService.GetTwoLetterIsoLanguageName(await _workContext.GetWorkingLanguageAsync());
            var url = string.Format(CommonDefaults.NopNewsRssPath,
                NopVersion.FULL_VERSION,
        ...
        {
            //prepare URL to request
            var url = string.Format(CommonDefaults.NopInstallationCompletedPath,
                    NopVersion.FULL_VERSION,
                    _webHelper.IsLocalRequest(_httpContextAccessor.HttpContext.Request),
        ...
        {
            //prepare URL to request
            var url = string.Format(CommonDefaults.NopSubscribeNewslettersPath,
                    WebUtility.UrlEncode(email))
                .ToLowerInvariant();
        ...
        public virtual async Task<string> GetExtensionsCategoriesAsync()
        {
            //prepare URL to request
            var language = _languageService.GetTwoLetterIsoLanguageName(await _workContext.GetWorkingLanguageAsync());
            var url = string.Format(CommonDefaults.NopExtensionsCategoriesPath, language).ToLowerInvariant();
        ...
        public virtual async Task<string> GetExtensionsVersionsAsync()
        {
            //prepare URL to request
            var language = _languageService.GetTwoLetterIsoLanguageName(await _workContext.GetWorkingLanguageAsync());
            var url = string.Format(CommonDefaults.NopExtensionsVersionsPath, language).ToLowerInvariant();
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            //prepare URL to request
            var language = _languageService.GetTwoLetterIsoLanguageName(await _workContext.GetWorkingLanguageAsync());
            var url = string.Format(CommonDefaults.NopExtensionsPath,
