...
namespace ARWNI2S.Framework.Common
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        public virtual async Task<StateProvince> GetStateProvinceByAbbreviationAsync(string abbreviation, int? countryId = null)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(DirectoryDefaults.StateProvincesByAbbreviationCacheKey
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(DirectoryDefaults.StateProvincesByCountryCacheKey, countryId, languageId, showHidden);
        ...
        public virtual async Task<IList<StateProvince>> GetStateProvincesAsync(bool showHidden = false)
        {
            ...
            var stateProvinces = await _staticCacheManager.GetAsync(_staticCacheManager.PrepareKeyForDefaultCache(DirectoryDefaults.StateProvincesAllCacheKey, showHidden), async () => await query.ToListAsync());
