...
namespace ARWNI2S.Framework.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        {
            var workingLanguage = await _workingContext.GetWorkingLanguageAsync();
        ...
        //    //localized value
        //    var workingLanguage = await _workingContext.GetWorkingLanguageAsync();
        //    var resourceName = $"{LocalizationDefaults.PermissionLocaleStringResourcesPrefix}{permissionRecord.SystemName}";
        //    var result = await GetResourceAsync(resourceName, languageId ?? workingLanguage.Id, false, string.Empty, true);
            ...
            where TPlugin : IPlugin
        {
            ...
            //localized value
            var resourceName = $"{LocalizationDefaults.PluginNameLocaleStringResourcesPrefix}{systemName}";
