...
namespace ARWNI2S.Framework.Users.Security
{
    ...
    public partial class AclService : IAclService
    {
        ...
        protected virtual async Task<bool> IsEntityAclMappingExistAsync<TEntity>() where TEntity : DataEntity, IAclSupported
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(UserSecurityDefaults.EntityAclRecordExistsCacheKey, entityName);
        ...
        public virtual async Task<int[]> GetUserRoleIdsWithAccessAsync(int entityId, string entityName)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(UserSecurityDefaults.AclRecordCacheKey, entityId, entityName);
