...
namespace ARWNI2S.Framework.Users.Entities
{
    ...
    /// Represents a user
    /// </summary>
    public partial class User : DataEntity, ISoftDeletedEntity
    {
        public User()
        {
        ...
        /// <summary>
        /// Gets or sets the vendor identifier with which this user is associated (manager)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the user is required to change password
        /// </summary>
