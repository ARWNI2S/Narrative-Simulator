...
using ARWNI2S.CodeGenerator.Hashing;
...
namespace ARWNI2S.CodeGenerator
{
    ...
    {
        public List<string> GenerateSerializerAttributes { get; } = new() { "ARWNI2S.GenerateSerializerAttribute" };
        public List<string> IdAttributes { get; } = new() { "ARWNI2S.IdAttribute" };
        public List<string> AliasAttributes { get; } = new() { "ARWNI2S.AliasAttribute" };
        public List<string> ImmutableAttributes { get; } = new() { "ARWNI2S.ImmutableAttribute" };
        public List<string> ConstructorAttributes { get; } = new() { "ARWNI2S.OrleansConstructorAttribute", "Microsoft.Extensions.DependencyInjection.ActivatorUtilitiesConstructorAttribute" };
    ...
    public class CodeGenerator
    {
        ...
        public CompilationUnitSyntax GenerateCode(CancellationToken cancellationToken)
        {
            ...
            var usings = List(new[] { UsingDirective(ParseName("global::ARWNI2S.Serialization.Codecs")), UsingDirective(ParseName("global::ARWNI2S.Serialization.GeneratedCodeHelpers")) });
