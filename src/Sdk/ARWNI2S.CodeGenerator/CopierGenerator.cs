...
using static ARWNI2S.CodeGenerator.InvokableGenerator;
using static ARWNI2S.CodeGenerator.SerializerGenerator;
...
namespace ARWNI2S.CodeGenerator
{
    internal class CopierGenerator
    {
            ...
            Dictionary<ISerializableTypeDescription, TypeSyntax> defaultCopiers)
        {
            ...
            var baseType = isExceptionType ? QualifiedName(AliasQualifiedName("global", IdentifierName("ARWNI2S.Serialization.GeneratedCodeHelpers.OrleansGeneratedCodeHelper")), GenericName(Identifier("ExceptionCopier"), TypeArgumentList(SeparatedList(new[] { type.TypeSyntax, type.BaseType.ToTypeSyntax() }))))
