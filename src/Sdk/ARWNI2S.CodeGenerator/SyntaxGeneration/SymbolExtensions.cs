...
namespace ARWNI2S.CodeGenerator.SyntaxGeneration
{
    internal static class SymbolExtensions
    {
        ...
        public static bool HasAttribute(this INamedTypeSymbol symbol, INamedTypeSymbol attributeType, bool inherited) => symbol.GetAttribute(attributeType, inherited) is not null;
        ...
        {
            return typeSymbol.ToDisplayName(new DisplayNameOptions { Substitutions = substitutions, IncludeGlobalSpecifier = includeGlobalSpecifier, IncludeNamespace = includeNamespace });
        }
        ...
        public static bool HasAnyAttribute(this ISymbol symbol, INamedTypeSymbol[] attributeTypes) => symbol.GetAnyAttribute(attributeTypes) != null;
        ...
        public static bool HasAttribute(this ISymbol symbol, INamedTypeSymbol attributeType) => symbol.GetAttribute(attributeType) != null;
        ...
        public static bool IsAssignableFrom(this INamedTypeSymbol symbol, INamedTypeSymbol type)
        {
            ...
            {
                return symbol.IsInterfaceAssignableFromInternal(type);
            }
